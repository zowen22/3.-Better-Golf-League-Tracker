...
_SETTINGS_DEFAULTS = {
    ...
    'best_ball_points_per_hole': 2.0,
    'best_ball_tie_points': 1.0,
    'best_ball_overall_point': 2.0,
    'team_totals_points_per_hole': 2.0,
    'team_totals_tie_points': 1.0,
    'team_totals_overall_point': 2.0,
    'classical_stroke_play_points_per_stroke': 1.0,
...
def settings(season_id):
    ...
    if request.method == 'POST':
        ...
        data = {
            ...
            'match_play_tie_points':         _float('match_play_tie_points', 1.0),
            'match_play_overall_point':      _int('match_play_overall_point', 2),
            'best_ball_points_per_hole':     _float('best_ball_points_per_hole', 2.0),
            'best_ball_tie_points':          _float('best_ball_tie_points', 1.0),
            'best_ball_overall_point':       _float('best_ball_overall_point', 2.0),
            'team_totals_points_per_hole':   _float('team_totals_points_per_hole', 2.0),
            'team_totals_tie_points':        _float('team_totals_tie_points', 1.0),
            'team_totals_overall_point':     _float('team_totals_overall_point', 2.0),
            'classical_stroke_play_points_per_stroke': _float('classical_stroke_play_points_per_stroke', 1.0),
            ...
            'all_skins_paid_upfront':        _bool('all_skins_paid_upfront'),
        ...
        if existing:
            db.execute(
                """UPDATE league_settings SET
                   ...
                   match_play_tie_points=%(match_play_tie_points)s,
                   match_play_overall_point=%(match_play_overall_point)s,
                   best_ball_points_per_hole=%(best_ball_points_per_hole)s,
                   best_ball_tie_points=%(best_ball_tie_points)s,
                   best_ball_overall_point=%(best_ball_overall_point)s,
                   team_totals_points_per_hole=%(team_totals_points_per_hole)s,
                   team_totals_tie_points=%(team_totals_tie_points)s,
                   team_totals_overall_point=%(team_totals_overall_point)s,
                   classical_stroke_play_points_per_stroke=%(classical_stroke_play_points_per_stroke)s,
                   ...
                   all_skins_paid_upfront=%(all_skins_paid_upfront)s,
            ...
            db.execute(
                """INSERT INTO league_settings
                   (league_id, season_id,
                    ...
                    skins_default_gross_net, skins_default_amount, all_skins_paid_upfront,
                   ...
                   (%(league_id)s, %(season_id)s,
                    ...
                    %(match_play_points_per_hole)s, %(match_play_tie_points)s, %(match_play_overall_point)s,
                    %(best_ball_points_per_hole)s, %(best_ball_tie_points)s, %(best_ball_overall_point)s,
                    %(team_totals_points_per_hole)s, %(team_totals_tie_points)s, %(team_totals_overall_point)s,
                    %(classical_stroke_play_points_per_stroke)s,
                    ...
                    %(skins_default_gross_net)s, %(skins_default_amount)s, %(all_skins_paid_upfront)s,
