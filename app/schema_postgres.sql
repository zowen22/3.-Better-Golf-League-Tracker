...
CREATE TABLE IF NOT EXISTS league_settings (
    ...
    match_play_points_per_hole INTEGER NOT NULL DEFAULT 2,
    match_play_tie_points REAL NOT NULL DEFAULT 1.0,
    match_play_overall_point INTEGER NOT NULL DEFAULT 2,
...
-- app layer, not a separate award_types table.
...
-- Stripe billing state, one row per league. Source of truth is Stripe
-- (via webhooks) -- this table mirrors it, doesn't compute anything
-- independently.
